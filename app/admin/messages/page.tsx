...
export default function MessagesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Message History</h1>
        <p className="text-gray-400">View all messages received through the consultation form</p>
      </div>
      <MessageHistory />
    </div>
  )
