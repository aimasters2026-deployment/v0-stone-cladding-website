// Message type icons as inline SVG components
export function ConsultationIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SupportIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M18 14c.828-1.007 1.675-2.473 1.675-4.5 0-4.418-3.806-8-8.5-8S2.675 5.082 2.675 9.5c0 2.027.847 3.493 1.675 4.5M12 16v-2M7 14s.5 2 5 2 5-2 5-2" />
      <path d="M9 18h6" />
...
export function MaterialIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
