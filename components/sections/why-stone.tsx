        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="glass p-6 rounded-xl border border-white/10 hover:border-orange-500/50 hover-lift">
                <p className="text-3xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">30-40%</p>
                <p className="text-sm text-gray-400">Energy cost reduction potential</p>
              </div>
              <div className="glass p-6 rounded-xl border border-white/10 hover:border-orange-500/50 hover-lift">
                <p className="text-3xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">50+</p>
                <p className="text-sm text-gray-400">Years lifespan with minimal maintenance</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="flex gap-4 p-3 glass-sm rounded-lg hover:bg-white/10 transition-colors">
                    <div className="flex-shrink-0 p-2 bg-gradient-to-br from-orange-500/20 to-orange-400/10 rounded-lg h-fit border border-orange-500/20">
                      <Icon className="h-5 w-5 text-orange-400" />
                    </div>
                    <div>
                      <h4 className="font-bold text-white mb-1 font-space-grotesk">
                        {benefit.title}
                      </h4>
